                ...
                <Col xl={selectedPayout ? 8 : 12}>
                    <Card className="border-0 shadow-sm rounded-4 p-3 bg-white">
                        <div className="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom">
                            <h6 className="fw-bold text-dark mb-0" style={{ fontSize: '1.05rem' }}>Payouts List</h6>
                            <div className="d-flex align-items-center gap-2">
                                <Form.Control type="text" value="20 May 2026 - 20 Jun 2026" readOnly className="form-control-sm bg-light border-0 text-muted w-auto" style={{ fontSize: '0.8rem', borderRadius: '6px' }} />
                        ...
                        <div className="d-flex align-items-center gap-4 mb-3 border-bottom overflow-x-auto" style={{ fontSize: '0.875rem' }}>
                            {[
                                { id: 'all', label: 'All Payouts (28)' },
                                { id: 'completed', label: 'Completed (20)' },
