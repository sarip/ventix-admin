                    ...
                    <Card className="border-0 shadow-sm rounded-4 p-3 bg-white">
                        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                            <div className="nav nav-pills bg-light rounded-pill p-1" style={{ fontSize: '0.78rem' }}>
                                <button className={`nav-link border-0 rounded-pill py-1 px-3 ${activeTab === 'all' ? 'bg-primary text-white' : 'text-muted'}`} onClick={() => setActiveTab('all')}>All Customers</button>
                                <button className={`nav-link border-0 rounded-pill py-1 px-3 ${activeTab === 'top' ? 'bg-primary text-white' : 'text-muted'}`} onClick={() => setActiveTab('top')}>Top Customers</button>
                                <button className={`nav-link border-0 rounded-pill py-1 px-3 ${activeTab === 'new' ? 'bg-primary text-white' : 'text-muted'}`} onClick={() => setActiveTab('new')}>New Customers</button>
                                <button className={`nav-link border-0 rounded-pill py-1 px-3 ${activeTab === 'repeat' ? 'bg-primary text-white' : 'text-muted'}`} onClick={() => setActiveTab('repeat')}>Repeat Customers</button>
                            </div>
                            <div className="d-flex align-items-center gap-2">
                                <div className="position-relative" style={{ width: '220px' }}>
                                    ...
                                    <input type="text" className="form-control form-control-sm ps-4 bg-light border-0" placeholder="Search name, email, or phone..." style={{ fontSize: '0.78rem' }} />
                                </div>
