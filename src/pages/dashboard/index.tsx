                    ...
                    <Card className="border-0 shadow-sm rounded-4 p-3 bg-white">
                        ...
                        <div className="d-flex align-items-center gap-4 mb-3 border-bottom" style={{ fontSize: '0.875rem' }}>
                            {[
                                ...
                                <button
                                    key={tab.id}
                                    className={`btn btn-link text-decoration-none px-0 py-2 border-0 fw-semibold cursor-pointer ${activeTab === tab.id ? 'text-primary border-bottom border-2 border-primary' : 'text-secondary opacity-75 hover-opacity-100'}`}
                                    style={{
                                        borderRadius: 0,
                                        marginBottom: '-1px',
                                        fontSize: '0.85rem'
