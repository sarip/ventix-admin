...
class UserpointLog extends Model
{
    ...
    protected $table            = 'userpoint_logs';
    ...
    protected $allowedFields    = [
        'user_id', 'source_id', 'source_type', 'source_code', 'point_cat', 'activity_type', 'amount', 'point_status', 'description', 'expiry_date', 'activated_at'
    ];
