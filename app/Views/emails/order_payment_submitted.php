...
<head>
    ...
    <title>Pembayaran Dalam Verifikasi – Veentix</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <p>Bukti pembayaran Anda telah kami terima</p>
            </div>
            ...
            <div class="card-body">
                ...
                <p>Terima kasih! Bukti pembayaran untuk pesanan berikut telah kami terima dan sedang dalam proses
                    verifikasi oleh tim kami.</p>

                <div class="order-box">
                    <div class="order-code">
                        <?= esc($order->order_code) ?>
                    </div>
                    <div class="order-meta">Metode Pembayaran: <strong>
                ...
                <div class="status-steps">
                    ...
                    <div class="step">
                        ...
                        <span class="step-label pending">Tiket dikirim ke email Anda</span>
                    </div>
                </div>

                <hr class="divider">
                <p style="font-size:14px;color:#6b7280">
                    Proses verifikasi biasanya memakan waktu <strong>1×24 jam</strong>. Setelah terverifikasi, Anda akan
                    mendapatkan tiket event via email ini.
                </p>
            </div>
